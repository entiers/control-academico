...
public enum TipoActividad {
    ...
    ASIGNACION_PRIMERA_RESTRASADA(2, "PRIMERA RETRASADA"),
    ASIGNACION_SEGUNDA_RETRASADA(3, "SEGUNDA RETRASADA"),
    ASIGNACION_VACACIONES(4, "CURSO DE VACACIONES"),
    DESASIGNACION_CURSOS(5,"DESASIGNACION DE CURSOS"),
    INGRESO_NOTAS(6,"INGRESO DE NOTAS")
    ;
