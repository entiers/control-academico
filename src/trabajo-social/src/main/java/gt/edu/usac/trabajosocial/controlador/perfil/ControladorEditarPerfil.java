...
import gt.edu.usac.trabajosocial.dominio.wrapper.WrapperPerfil;
...
//______________________________________________________________________________
    ...
    public String editar(@Valid WrapperPerfil wrapperPerfil, BindingResult bindingResult,
        ...
        try {
            ...
            this.servicioPerfilImpl.actualizarPerfil(this.perfil);

            // se registra el evento
            MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarPerfil.exito", true);
