...
import gt.edu.usac.trabajosocial.dominio.busqueda.DatosBusquedaSalon;
...
//______________________________________________________________________________
    ...
    public String buscarSalon(@Valid DatosBusquedaSalon datosBusquedaSalon,
        ...
        try {
            ...
            this.salon = this.servicioSalonImpl.buscarSalonPorNumeroYEdificio(numero, edificio);

            if(this.salon == null)
                MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarSalon.sinResultados", true);
            else
...
//______________________________________________________________________________
    ...
    public String submit(@Valid WrapperSalon wrapperSalon, BindingResult bindingResult,
        ...
        try {
            ...
            this.servicioSalonImpl.actualizarSalon(this.salon);

            // se registra el evento
            MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarSalon.exito", true);
