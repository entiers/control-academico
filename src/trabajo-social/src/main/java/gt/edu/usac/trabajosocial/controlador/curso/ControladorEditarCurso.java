...
import gt.edu.usac.trabajosocial.dominio.busqueda.DatosBusquedaCurso;
...
//______________________________________________________________________________
     ...
     * de editar curso. Las busquedas solo se realizan por el cÃ³digo. El metodo
    ...
    public String buscarCurso(@Valid DatosBusquedaCurso datosBusquedaCurso,
        ...
        try {
            ...
            if(this.curso == null)
                MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarCurso.sinResultados", true);
            else
...
//______________________________________________________________________________
    ...
    public String submit(@Valid WrapperCurso wrapperCurso, BindingResult bindingResult,
        ...
        try {
            ...
            this.servicioCursoImpl.actualizarCurso(this.curso);

            // se registra el evento
            MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarCurso.exito", true);
