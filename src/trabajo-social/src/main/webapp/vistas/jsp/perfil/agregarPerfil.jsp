<%-- 
    ...
    Created on : Aug 6, 2010, 5:36:53 AM
    Author     : Mario Batres
--%>
...
<html>
    <head>
        ...
        <title><fmt:message key="agregarPerfil.titulo"/></title>
        <%@include file="../../jspf/scripts/scriptPerfil.jspf" %>
    </head>
    <body>
        <h1><fmt:message key="agregarPerfil.titulo"/></h1>
        <%-- formulario para ingresar los datos del perfil --%>
