...
//______________________________________________________________________________
    /**
     * M�todo que se encarga de la apertura del socket para realizar el ETL Y se
     * hace el llamado al m�todo <b>realizarETL</b> que es implementado en las clases
     * hijas.
     *
     * @return De tipo <b>String [][]</b>. Arreglo bidimensional de cadenas que
     * retornan lo ocurrido en la realizaci�n del proceso.
     *
     * @throws IOException
     */
