...
//______________________________________________________________________________
    ...
    public String buscar(@Valid DatosBusquedaHorario datosBusquedaHorario, BindingResult bindingResult,
        ...
        try{
            ...
            if(listadoHorarios == null || listadoHorarios.size() == 0){
                MensajePopup.configurar(request, true, true, TITULO_MENSAJE_BUSCAR, "buscarHorario.sinResultados");
            }
            modelo.addAttribute("horarios", listadoHorarios);
        } catch (DataAccessException e) {
            // error de acceso a datos
            MensajePopup.configurar(request, false, false, TITULO_MENSAJE_BUSCAR, "dataAccessException");
    ...
    public String editar(@Valid WrapperHorario wrapperHorario, BindingResult bindingResult,
        ...
        try {
            ...
            MensajePopup.configurar(request, true, true, TITULO_MENSAJE_EDITAR, "editarHorario.exito");
            log.info("Actualizar horario, ID: " + horario.getIdHorario());

        } catch (DataAccessException e) {
            // error de acceso a datos
            MensajePopup.configurar(request, false, false, TITULO_MENSAJE_EDITAR, "dataAccessException");
            log.error(Mensajes.DATA_ACCESS_EXCEPTION, e);
        }
