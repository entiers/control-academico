<%-- 
    Document   : rptActaPreliminarNotas
    Created on : 08-oct-2014, 18:54:56
    Author     : maria
--%>
                ...
                <div id="divCampos">
                    ...
                    <select name="valorParametro" id="valorParametro">
                        <c:forEach items="${listadoHorario}" var="horario">
                            <option value="${horario.idHorario}">[${horario.asignacionCursoPensum.curso.codigo}] ${horario.asignacionCursoPensum.curso.nombre} - ${horario.seccion} [${horario.asignacionCursoPensum.numeroSemestre}]</option>
                        </c:forEach>
                    </select>
