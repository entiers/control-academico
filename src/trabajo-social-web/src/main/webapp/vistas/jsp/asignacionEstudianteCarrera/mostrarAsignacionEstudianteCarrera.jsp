...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var llenarFormularioEquivalencia = function(idAecOriginal, aecOriginalCodigoNombre){
                $("#formEquivalencia #idAecOriginal").val(idAecOriginal);
                $("#formEquivalencia #aecOriginalCodigoNombre").html(aecOriginalCodigoNombre);
                $("#divFormularioEquivalencia").dialog("open"); 
            }
    ...
    <body>
        ...
        <fieldset style="margin-top: 70px;">
            ...
            <center>
                <display:table class="ui-widget ui-widget-content" name="listadoAsignacionEstudianteCarreraNoAsignadas" id="asignacionEstudianteCarrera">
                    ...
                    <display:column titleKey="acciones" style="text-align:center">
                        <a style="cursor:pointer;" onclick="llenarFormularioEquivalencia(${asignacionEstudianteCarrera.idAsignacionEstudianteCarrera}, '${asignacionEstudianteCarrera.carrera.codigoNombre}');">  		    
        ...
        <div id="divFormularioEquivalencia" title="<fmt:message key="cursoPensum.titulo.realizarEquivalencia" />">
            ...
            <form:form id="formEquivalencia" modelAttribute="wrapperEquivalenciaPorCarrera" method="POST" 
                ...
                <div id="divCampos">
                    ...
                    <form:hidden id="idAecOriginal" path="asignacionEstudianteCarreraOriginal.idAsignacionEstudianteCarrera" />
                    <span id="aecOriginalCodigoNombre"></span>
                </div> 
                ...
                <div id="divCampos">
                    ...
                    <c:choose>
                        <c:when test="${fn:length(listadoAsignacionEstudianteCarrera) > 1}">
                            <form:select path="asignacionEstudianteCarreraEquivalencia.idAsignacionEstudianteCarrera"
                                         items="${listadoAsignacionEstudianteCarrera}"
                                         itemValue="idAsignacionEstudianteCarrera" itemLabel="carrera.codigoNombre"    />
                        </c:when>
                        <c:otherwise>
                            <form:hidden path="asignacionEstudianteCarreraEquivalencia.idAsignacionEstudianteCarrera" 
                                         id="idAsignacionEstudianteCarreraEquivalencia"/>
                            ...
                            <c:forEach items="${listadoAsignacionEstudianteCarrera}" var="asignacionEstudianteCarrera">
                                ...
                                <c:set scope="request" var="idAsignacionEstudianteCarreraEquivalencia" 
                                       value="${asignacionEstudianteCarrera.idAsignacionEstudianteCarrera}" />
                            </c:forEach>

                            <script type="text/javascript">
                                $(function (){
                                    $("#idAsignacionEstudianteCarreraEquivalencia").val("${idAsignacionEstudianteCarreraEquivalencia}");
                                });
                            </script>
                        </c:otherwise>
                    </c:choose>
