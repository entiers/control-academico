...
/**
 * <p>Este controlador lleva el manejo de las vistas <code>mostrarAsignacionEstudianteCarrera.htm</code>
 * , <code>agregarAsignacionEstudianteCarrera.htm</code> y <code>modificarAsignacionEstudianteCarrera.htm</code>
...
//______________________________________________________________________________
    /**
     * <p>Lleva el nombre del titulo para el mensaje en la pagina <code>agregarAsignacionEstudianteCarrera.htm</code></p>
     */
    private static String TITULO_MENSAJE_AGREGAR = "agregarAsignacionEstudianteCarrera.titulo";
//______________________________________________________________________________
    /**
     * <p>Lleva el nombre del titulo para el mensaje en la pagina <code>modificarAsignacionEstudianteCarrera.htm</code></p>
     */
...
//______________________________________________________________________________
     ...
     * p&aacute;gina <code>mostrarAsignacionEstudianteCarrera.htm</code>.
     * Crea y busca los atributos para mostrar en dicha p&aacute;gina de acuerdo
     * con el id del estudiante en la base de datos.
     *
...
//______________________________________________________________________________
     ...
     * a la p&aacute;gina <code>agregarAsignacionEstudianteCarrera.htm</code>.
     * Se encarga de agregar una nueva asignaci&oacute;n de carrera al estudiante que
    ...
    /**
     * Este m&eacute;todo se ejecuta cuando se hace una llamada de tipo <b>POST</b>
     * a la p&aacute;gina <code>modificarAsignacionEstudianteCarrera.htm</code>.
     * Se encarga de modificar una asignaci&oacute;n de carrera al estudiante que
     * ha sido seleccionado previamente.
     *
     * @param modelo Objeto de tipo {@link Model}
     * @param wrapperModificarAsignacionEstudianteCarrera Objeto de tipo {@link WrapperModificarAsignacionEstudianteCarrera}
     * @param bindingResult Objeto de tipo {@link BindingResult}
     * @param request Objeto de tipo {@link HttpServletRequest}
     */
