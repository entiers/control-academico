...
//______________________________________________________________________________
    ...
    public String crearFormulario(Model modelo, short idTipoAsignacion, HttpServletRequest request) {
        ...
        this.tipoAsignacion = this.servicioAsignacionImpl.cargarEntidadPorID(TipoAsignacion.class, idTipoAsignacion);

        if(this.tipoAsignacion == null){
            RequestUtil.crearMensajeRespuesta(request, TITULO_MENSAJE, "buscarTipoAsignacion.sinResultados", false);
    ...
    public String editar(@Valid WrapperTipoAsignacion wrapperTipoAsignacion, BindingResult bindingResult,
        ...
        try {
            ...
            this.servicioAsignacionImpl.actualizar(this.tipoAsignacion);

            // se registra el evento
            RequestUtil.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarTipoAsignacion.exito", true);
