...
//______________________________________________________________________________
    ...
    public String eliminar(Model modelo, short idTipoAsignacion, HttpServletRequest request){
        ...
        try{
            TipoAsignacion tipoAsignacion = this.servicioAsignacionImpl.cargarEntidadPorID(TipoAsignacion.class, idTipoAsignacion);
         
            try{
                this.servicioAsignacionImpl.borrar(tipoAsignacion);
                ...
                this.servicioAsignacionImpl.actualizar(tipoAsignacion);
            }

            List <TipoAsignacion> listadoTipoAsignacion = this.servicioAsignacionImpl.buscarTipoAsignacionHabilitado();
            modelo.addAttribute("listadoTipoAsignacion", listadoTipoAsignacion);

            // se registra el evento
            RequestUtil.crearMensajeRespuesta(request, TITULO_MENSAJE, "eliminarTipoAsignacion.exito", true);
