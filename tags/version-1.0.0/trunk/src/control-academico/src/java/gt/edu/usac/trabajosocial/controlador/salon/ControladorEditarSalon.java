...
//______________________________________________________________________________
    ...
    public String buscarSalon(@Valid DatosBusquedaSalon datosBusquedaSalon,
        ...
        try {
            ...
            if(this.salon == null)
                MensajePopup.configurar(request, true, true, TITULO_MENSAJE, "editarSalon.sinResultados");
            else
    ...
    public String submit(@Valid WrapperSalon wrapperSalon, BindingResult bindingResult,
        ...
        try {
            ...
            MensajePopup.configurar(request, true, true, TITULO_MENSAJE, "editarSalon.exito");
            log.info("Actualizar salon, numero: " + this.salon.getNumero());
