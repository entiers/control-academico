...
INSERT INTO "control".rol(id_rol, nombre, descripcion)
    VALUES (1, 'USUARIO_REGISTRADO', 'Identifica a un usuario registrado en el sistema');
    
-- Roles para el area de estudiante
INSERT INTO control.rol(id_rol, nombre, descripcion)
...
-- Roles para el area de catedratico
INSERT INTO control.rol(id_rol, nombre, descripcion)
...
-- Se asignan los roles correspondientes al perfil estudiante
INSERT INTO control.asignacion_rol_perfil(id_asignacion_rol_perfil, id_perfil, id_rol)
    VALUES (10, 2, 1);
    
-- Se asignan los roles correspondientes al perfil catedratico
INSERT INTO control.asignacion_rol_perfil(id_asignacion_rol_perfil, id_perfil, id_rol)
    VALUES (11, 3, 1);
