...
package gt.edu.usac.cats.controlador.tipoAsignacion;

import gt.edu.usac.cats.dominio.TipoAsignacion;
import gt.edu.usac.cats.dominio.wrapper.WrapperTipoAsignacion;
 ...
 * @version 1.0
 */
@Controller("controladorAgregarTipoAsignacion")
@RequestMapping(value = "agregarTipoAsignacion.htm")
public class ControladorAgregarTipoAsignacion {

    /**
     * <p>Lleva el nombre del titulo para el mensaje en la pagina.<p>
     */
    private static final String TITULO_MENSAJE = "agregarTipoAsignacion.titulo";

//______________________________________________________________________________
    /**
     * <p>Matiene una bitacora de lo realizado por esta clase.</p>
     */
    private static Logger log = Logger.getLogger(ControladorAgregarTipoAsignacion.class);
...
//______________________________________________________________________________
    ...
    public String crearFormulario(Model modelo) {
        ...
        modelo.addAttribute("wrapperTipoAsignacion", new WrapperTipoAsignacion());

        return "tipoAsignacion/agregarTipoAsignacion";
    }

//______________________________________________________________________________
    /**
     * <p>Este metodo es llamado cuando se realiza un SUBMIT desde la pagina de
     * agregar tipo de asignacion <code>agregarTipoAsignacion.htm</code>. El
     ...
     * </ul></p>
     *
     * @param wrapperTipoAsignacion Pojo del tipo {@link WrapperTipoAsignacion}
    ...
    public String submit(@Valid WrapperTipoAsignacion wrapperTipoAsignacion, BindingResult bindingResult,
        ...
        try {
            ...
            wrapperTipoAsignacion.quitarWrapper(tipoAsignacion);
            this.servicioAsignacionImpl.agregar(tipoAsignacion);
            modelo.addAttribute("wrapperTipoAsignacion", new WrapperTipoAsignacion());
            
            // se registra el evento
            RequestUtil.crearMensajeRespuesta(request, TITULO_MENSAJE, "agregarTipoAsignacion.exito", true);
            String msg = Mensajes.EXITO_AGREGAR + "Tipo Asignacion, id = " + tipoAsignacion.getIdTipoAsignacion();
            log.info(msg);
