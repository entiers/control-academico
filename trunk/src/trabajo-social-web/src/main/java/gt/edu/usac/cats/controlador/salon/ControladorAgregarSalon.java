...
public class ControladorAgregarSalon implements Serializable {
...
//______________________________________________________________________________
    ...
    public String submit(@Valid WrapperSalon wrapperSalon, BindingResult bindingResult,
        ...
        try {
            ...
            this.servicioHorarioImpl.agregar(salon);

            // se registra el evento
            RequestUtil.crearMensajeRespuesta(request, TITULO_MENSAJE, "agregarSalon.exito", true);
