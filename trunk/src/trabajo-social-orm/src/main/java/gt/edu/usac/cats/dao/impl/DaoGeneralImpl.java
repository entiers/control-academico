...
package gt.edu.usac.cats.dao.impl;
...
public class DaoGeneralImpl extends HibernateDaoSupport implements DaoGeneral {
    ...
    /**
     * <p>Cantidad maxima de registros que se mostraran las consultas que
     * se realicen con paginacion.</p>
     */
    public final static int REGISTROS_MAXIMOS = 10;
