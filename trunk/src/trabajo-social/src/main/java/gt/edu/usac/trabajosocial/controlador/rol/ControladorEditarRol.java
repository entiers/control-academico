...
import gt.edu.usac.trabajosocial.dominio.wrapper.WrapperRol;
...
//______________________________________________________________________________
    ...
    public String crearFormulario(Model modelo, short idRol, HttpServletRequest request) {
        ...
        this.rol = this.servicioRolImpl.getRolPorID(idRol);

        if(this.rol == null){
            MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "buscarRol.sinResultados", false);
    ...
    public String editar(@Valid WrapperRol wrapperRol, BindingResult bindingResult,
        ...
        try {
            ...
            this.servicioRolImpl.actualizarRol(this.rol);

            // se registra el evento
            MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "editarRol.exito", true);
