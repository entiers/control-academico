...
//______________________________________________________________________________
    ...
    public String submit(@Valid WrapperSemestre wrapperSemestre, BindingResult bindingResult,
        ...
        try {
            ...
            MensajePopup.crearMensajeRespuesta(request, TITULO_MENSAJE, "agregarSemestre.exito", true);
            String msg = Mensajes.EXITO_AGREGAR + "Semestre, anio " + semestre.getAnio() + " y n̼mero " + semestre.getNumero();
            log.info(msg);
